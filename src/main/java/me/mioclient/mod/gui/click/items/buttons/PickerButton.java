...
public class PickerButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Managers.TEXT.drawStringWithShadow(((newStyle || dotgod) ? getName().toLowerCase() : getName()), x + 2.3f, y - 1.7f - (float) MioClickGui.INSTANCE.getTextOffset(), (dotgod && setting.hasBoolean && setting.booleanValue) ? Managers.COLORS.getCurrentGui(240) : dotgod ? 0xB0B0B0 : -1);
