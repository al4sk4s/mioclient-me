...
public abstract class Shader {
    ...
    public Shader(String fragmentShader) {
        ...
        try {
            InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/textures/mio/shader/vertex/vert/vertex.vert");
            ...
            InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/textures/mio/shader/fragment/frag/" + fragmentShader);
